...
export async function createContact(data: ContactData) {
  ...
  // Create contact - following example.ts database operation pattern
  ...
  // Revalidate the cache - following existing pattern
...
// Legacy example action template (kept for reference)
